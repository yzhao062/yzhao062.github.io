...
1. Copy this README into a `todo/` folder at the repo root.
2. Add the `.gitignore` stanza above.
3. Commit both. The folder then exists on every clone, empty and self-documenting.
